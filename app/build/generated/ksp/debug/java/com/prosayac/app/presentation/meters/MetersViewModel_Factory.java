...
public final class MetersViewModel_Factory implements Factory<MetersViewModel> {
  ...
  public static MetersViewModel_Factory create(Provider<MeterRepository> meterRepositoryProvider,
      Provider<Context> contextProvider) {
    return new MetersViewModel_Factory(meterRepositoryProvider, contextProvider);
  }

  public static MetersViewModel newInstance(MeterRepository meterRepository, Context context) {
    return new MetersViewModel(meterRepository, context);
  }
}
